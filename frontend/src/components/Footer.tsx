      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-semibold">FemHealth</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/about" className="text-gray-300 hover:text-white transition-colors">About PCOS</Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/tracker" className="text-gray-300 hover:text-white transition-colors">Diet Tracker</Link>
              </li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:info@femhealth.com" className="text-gray-300 hover:text-white transition-colors">
                  info@femhealth.com
                </a>
              </li>
              <li className="flex items-center">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <p className="text-center text-gray-400">
            &copy; {new Date().getFullYear()} FemHealth. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
